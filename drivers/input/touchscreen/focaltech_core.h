...
#define FTS_FW_NAME_MAX_LEN	512
...
/* Lenovo Vendor ID define */
#define FTS_FW_VENDOR_ID_OFILM	0x01
#define FTS_FW_VENDOR_ID_MUTTO	0x08
...
#define FTS_STORE_TS_INFO(buf, id, name, max_tch, group_id, fw_vkey_support, \
			...
			snprintf(buf, FTS_INFO_MAX_LEN, \
				...
				fw_vkey_support, fw_name, fw_vendor, fw_maj, fw_min, \
				fw_sub_min)
...
struct fts_ts_platform_data {
	...
	u32 num_max_touches;
	u32 num_max_buttons;
	u32 button_map[FTS_MAX_BUTTONS];
	u32 button_y_coor;
	u32 button_x_coor[FTS_MAX_BUTTONS];
...
#define FTS_CTL_IIC
#define FTS_RESET_AFTER_GESTRUE_WAKEUP
...
extern int fts_get_upgrade_array(const char *chip_name);
...
extern int fts_ctpm_fw_upgrade_with_app_file(struct i2c_client *client, const char *firmware_name);
